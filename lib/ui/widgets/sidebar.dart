...
class Sidebar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final sidebarColor = isOverlay
        ? tokens.windowBg.withValues(alpha: 0.92)
        : tokens.sidebarBg.withValues(alpha: 0.72);
...
class _ActionButtonState extends State<_ActionButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final radius = widget.mobileCardStyle ? FlatRadius.md : FlatRadius.md;
    ...
    return Tooltip(
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          onTap: widget.onTap,
          child: Container(
            width: widget.mobileCardStyle ? 40 : 40,
            height: widget.mobileCardStyle ? 40 : 40,
            decoration: BoxDecoration(
              color: _hovering ? hoverBg : Colors.transparent,
              borderRadius: BorderRadius.circular(radius),
            ),
            child: Icon(widget.icon,
                size: widget.mobileCardStyle ? 20 : 20, color: fg),
          ),
        ),
      ),
    );
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        widget.icon,
                        size: widget.isMobileStyle ? 19 : 17,
                        color: iconColor,
                      ),
